...
+ (NSString*) storageFilePathForClass:(Class)classToStore;
{
    NSString* path = [NSSearchPathForDirectoriesInDomains( NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0];
    NSString *fileName = [NSString stringWithFormat:@"%@_%@s", kNSCODER_FILENAME_PREFIX, NSStringFromClass(classToStore)];
