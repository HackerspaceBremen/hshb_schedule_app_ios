...
- (NSString*) platformString {
	...
	[platformDict setValue:@"iPhone 5C"              forKey:@"iPhone6,1"];
	[platformDict setValue:@"iPhone 5C"              forKey:@"iPhone6,2"];
	[platformDict setValue:@"iPhone 5S"              forKey:@"iPhone6,3"];
	[platformDict setValue:@"iPhone 5S"              forKey:@"iPhone6,4"];
...
- (NSInteger) versionAsInteger {
    ...
    return [[versionString substringToIndex:1] intValue];
}
...
- (BOOL) isOS_7 {
    NSString *versionString = [self systemVersion];
    return ( [[versionString substringToIndex:1] intValue] >= 7 );
}
