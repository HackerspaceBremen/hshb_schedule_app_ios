...
- (float)hue {
	NSArray *colorValues = [self arrayFromRGBAComponents];
	float red = [[colorValues objectAtIndex:0] floatValue];
	float green = [[colorValues objectAtIndex:1] floatValue];
	float blue = [[colorValues objectAtIndex:2] floatValue];
...
- (float)brightness { // ATTN: unverified function; self hacked;
	NSArray *colorValues = [self arrayFromRGBAComponents];
	float red = [[colorValues objectAtIndex:0] floatValue];
	float green = [[colorValues objectAtIndex:1] floatValue];
	float blue = [[colorValues objectAtIndex:2] floatValue];
...
- (float)saturation {
     ...
     */
	 ...
	 // Saturation ranges from 0.0 -> 1.0
	 return fmax(0.0f, 1.0f - minChannel / maxChannel);	
}
